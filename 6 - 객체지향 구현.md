...
- 애플리케이션을 레이어 아키텍처의 형태로 구성한다고 가정
...
`WEB or Console Layer ---> Domain Layer ---> Persistence Layer`
...
- 해결방법: **다른 컴포넌트나 서비스가 직접 의존하지 않도록 중재하는 중간 객체에 책임을 할당**하라
...
- 해결 방법: 워크플로우를 표현하는 객체에게 책임을 할당하라
